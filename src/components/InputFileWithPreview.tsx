...
function InputFileWithPreview({onChange, value} : InputFileWithPreviewProps) {
  ...
  return (
    <div className="flex gap-3">
      <label className="btn-custom text-lg w-full flex flex-col justify-center items-center bg-white text-secondary shadow-lg tracking-wide uppercase border-2 border-secondary transition duration-300 ease-in-out bg-opacity-20 cursor-pointer hover:bg-secondary hover:text-white">
